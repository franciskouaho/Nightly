const fr = {
  ...
  game: {
    ...
    blindtest: {
      title: "🎵 Blind Test Générations",
      label: "🎵 BLIND TEST",
      round: "Round {{current}} / {{total}}",
      score: "Score: {{score}}",
      chooseCategory: "Choisis une catégorie",
      categorySelectionInProgress: "Choix de la catégorie en cours...",
      waitingForPlayer: "En attente de {{name}}...",
      noOneFound: "Personne n'a trouvé la réponse...",
      playersAlreadyTried: "{{count}} joueur a déjà essayé",
      playersAlreadyTried_plural: "{{count}} joueurs ont déjà essayé",
      correctAnswer: "Bonne réponse !",
      playerFound: "{{name}} a trouvé !",
      continue: "Continuer",
      question: "Question",
      tapToAnswer: "Tap to Answer",
      listening: "Listening",
      noAudioAvailable: "Pas d'extrait audio disponible",
      checkAudioUrl: "Vérifiez que l'URL audio est valide et accessible",
