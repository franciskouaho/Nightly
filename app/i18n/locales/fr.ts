const fr = {
  ...
  couples: {
    ...
    betweenUs: "entre nous",
    widgets: "Widgets",
    yourDaily: "Votre défi quotidien",
    history: "Historique",
    activateGPS: "Activer GPS",
    deactivateGPS: "Désactiver GPS",
    activateGPSHint: "Activez le GPS pour voir la distance",
    challengeCompleted: "Défi complété ! 🔥",
    dailyChallenge: "Défi du jour",
    respondToChallenge: "Répondre au défi",
    waitingForPartner: "En attente de votre partenaire...",
    noChallengeAvailable: "Aucun défi disponible aujourd'hui.",
    dailyConnectionHelp: "Votre connexion quotidienne aide votre série à grandir et renforce votre lien.",
    loadingChallenge: "Chargement...",
    days: "jours",
    day: "jour",
    selectJoinedDate: "Sélectionner la date de mise en couple",
    dateUpdated: "Date mise à jour avec succès",
  },
};
