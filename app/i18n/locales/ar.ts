export default {
  ...
  home: {
    ...
    games: {
      ...
      "never-have-i-ever-hot": {
        name: "لم أفعل أبداً 🔞",
        description: "أسئلة جريئة وغير مناسبة... هل أنت مستعد للاعتراف؟",
        tags: {
          premium: "بريميوم"
        }
      },
      ...
      "the-hidden-village": {
        name: "القرية المخفية",
        description: "لعبة خداع واستراتيجية ومناقشات... لمن يحب اتهام أصدقائه 😈",
        tags: {
          premium: "بريميوم"
        }
      },
      "trap-answer": {
        name: "إجابة الفخ",
        description: "اختبار حيث تجعلك الإجابة الخاطئة تخسر النقاط... هل ستتمكن من تجنب الفخاخ؟",
        tags: {
          free: "مجاني"
        }
      },
  ...
  game: {
    ...
    geniusOrLiar: {
      ...
      chooseTask: "اختر: حقيقة أم تحدي؟",
      isThinking: "يفكر...",
      willChoose: "سيختار",
      or: "أو",
      iAnswered: "أجبت",
      iRefuse: "تخطي الدور",
      voteInProgress: "تصويت جاري",
      otherPlayersDecide: "اللاعبون الآخرون يقررون إذا",
      playedGame: "لعب اللعبة",
      votes: "أصوات",
      vote: "تصويت",
      did: "هل",
      thanksVote: "شكراً لتصويتك!",
      yes: "نعم",
      no: "لا",
      round: "جولة",
    ...
    "two-letters-one-word": {
      "enterWord": "أدخل كلمتك...",
      "verify": "تحقق",
      "verifying": "جاري التحقق...",
      "score": "النتيجة",
      "theme": "الموضوع",
      "error": {
        "emptyWord": "الرجاء إدخال كلمة",
        "verificationFailed": "حدث خطأ أثناء التحقق"
      },
      "success": {
