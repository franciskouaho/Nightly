const en = {
  ...
  game: {
    ...
    blindtest: {
      title: "🎵 Generations Music Quiz",
      label: "🎵 BLIND TEST",
      round: "Round {{current}} / {{total}}",
      score: "Score: {{score}}",
      chooseCategory: "Choose a category",
      categorySelectionInProgress: "Category selection in progress...",
      waitingForPlayer: "Waiting for {{name}}...",
      noOneFound: "No one found the answer...",
      playersAlreadyTried: "{{count}} player already tried",
      playersAlreadyTried_plural: "{{count}} players already tried",
      correctAnswer: "Correct answer!",
      playerFound: "{{name}} found it!",
      continue: "Continue",
      question: "Question",
      tapToAnswer: "Tap to Answer",
      listening: "Listening",
      noAudioAvailable: "No audio clip available",
      checkAudioUrl: "Please check that the audio URL is valid and accessible",
