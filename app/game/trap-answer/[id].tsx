...
export default function TrapAnswerGame() {
  ...
  return (
    <LinearGradient
      colors={[ChristmasTheme.light.backgroundDarker, ChristmasTheme.light.backgroundDarker, ChristmasTheme.light.primary, ChristmasTheme.light.backgroundDarker, ChristmasTheme.light.background]}
    ...
    >
      <View style={{ flex: 1, paddingVertical: 40, paddingHorizontal: 12 }}>
        <View style={{ alignItems: 'center' }}>
          ...
          >
            <MaterialCommunityIcons name="sword-cross" size={38} color={ChristmasTheme.light.primary} />
