        ...
        rules: [
          {
            ...
            description: "Répondez aux questions sur Halloween et les créatures de la nuit. L'ambiance est sombre et mystérieuse !",
            emoji: "🎃",
            colors: {
              title: "#FF6F00",
              description: "#FFB347",
          ...
          },
          {
            ...
            description: "Vous n'avez qu'une seule tentative par question. Choisissez bien ou vous tomberez dans le piège !",
            emoji: "⚡",
            colors: {
              title: "#FFD700",
              description: "#FFB347",
          ...
          },
          {
            ...
            description: "Chaque bonne réponse vous rapporte 1 point. Attention aux pièges mortels !",
            emoji: "💀",
            colors: {
              title: "#DC143C",
              description: "#FF6F00",
          ...
          },
          {
            ...
            description: "Testez vos connaissances sur les films d'horreur, les traditions et les légendes d'Halloween. L'obscurité vous attend !",
            emoji: "🕷️",
            colors: {
              title: "#8B0000",
              description: "#DC143C",
          ...
          },
          {
            ...
            description: "Plongez dans l'atmosphère d'Halloween avec des toiles d'araignées et des décorations sombres !",
            emoji: "👻",
            colors: {
              title: "#FF6F00",
              description: "#FFD700",
        ...
        rules: [
          {
            ...
            description: "Answer questions about Halloween and creatures of the night. The atmosphere is dark and mysterious!",
            emoji: "🎃",
            colors: {
              title: "#FF6F00",
              description: "#FFB347",
          ...
          },
          {
            ...
            description: "You only have one attempt per question. Choose wisely or you'll fall into the trap!",
            emoji: "⚡",
            colors: {
              title: "#FFD700",
              description: "#FFB347",
          ...
          },
          {
            ...
            description: "Each correct answer earns you 1 point. Watch out for deadly traps!",
            emoji: "💀",
            colors: {
              title: "#DC143C",
              description: "#FF6F00",
          ...
          },
          {
            ...
            description: "Test your knowledge of horror movies, traditions and Halloween legends. Darkness awaits you!",
            emoji: "🕷️",
            colors: {
              title: "#8B0000",
              description: "#DC143C",
          ...
          },
          {
            ...
            description: "Dive into the Halloween atmosphere with spider webs and dark decorations!",
            emoji: "👻",
            colors: {
              title: "#FF6F00",
              description: "#FFD700",
        ...
        rules: [
          {
            ...
            description: "Responde preguntas sobre Halloween y criaturas de la noche. ¡La atmósfera es oscura y misteriosa!",
            emoji: "🎃"
          },
          {
            title: "⚡ Solo una oportunidad",
            description: "Solo tienes un intento por pregunta. ¡Elige sabiamente o caerás en la trampa!",
            emoji: "⚡"
          },
          {
            title: "💀 Puntos y puntuación",
            description: "Cada respuesta correcta te da 1 punto. ¡Cuidado con las trampas mortales!",
            emoji: "💀"
          },
          {
            title: "🕷️ Tema de Halloween",
            description: "Pon a prueba tus conocimientos sobre películas de terror, tradiciones y leyendas de Halloween. ¡La oscuridad te espera!",
            emoji: "🕷️"
          },
          {
            title: "👻 Ambiente espeluznante",
            description: "¡Sumérgete en la atmósfera de Halloween con telarañas y decoraciones oscuras!",
            emoji: "👻"
          }
        ]
      },
        ...
        rules: [
          {
            ...
            description: "Beantworte Fragen über Halloween und Kreaturen der Nacht.",
            emoji: "🎃"
          },
          {
          ...
          },
          {
            ...
            description: "Jede richtige Antwort bringt dir 1 Punkt. Achte auf Fallen!",
            emoji: "💀"
          },
          {
            title: "Halloween-Thema",
            description: "Teste dein Wissen über Horrorfilme, Traditionen und Halloween-Legenden.",
            emoji: "🕷️"
          }
        ]
      },
        ...
        rules: [
          {
            ...
            description: "Rispondi alle domande su Halloween e le creature della notte.",
            emoji: "🎃"
          },
          {
            title: "Solo una possibilità",
            description: "Hai solo un tentativo per domanda. Scegli saggiamente!",
            emoji: "⚡"
          },
          {
            title: "Punti e punteggio",
            description: "Ogni risposta corretta ti dà 1 punto. Attento alle trappole!",
            emoji: "💀"
          },
          {
            title: "Tema Halloween",
            description: "Metti alla prova le tue conoscenze sui film horror, tradizioni e leggende di Halloween.",
            emoji: "🕷️"
          }
        ]
      },
        ...
        rules: [
          {
            ...
            description: "Responda perguntas sobre Halloween e criaturas da noite.",
            emoji: "🎃"
          },
          {
            title: "Apenas uma chance",
            description: "Você só tem uma tentativa por pergunta. Escolha sabiamente!",
            emoji: "⚡"
          },
          {
            title: "Pontos e pontuação",
            description: "Cada resposta correta te dá 1 ponto. Cuidado com as armadilhas!",
            emoji: "💀"
          },
          {
            title: "Tema Halloween",
            description: "Teste seus conhecimentos sobre filmes de terror, tradições e lendas do Halloween.",
            emoji: "🕷️"
          }
        ]
      },
      ar: {
        rules: [
          ...
          },
          {
            ...
            description: "اختبر معرفتك بأفلام الرعب والتقاليد وأساطير الهالوين.",
            emoji: "🕷️"
          }
        ]
      }
