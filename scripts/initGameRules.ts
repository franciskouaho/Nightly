        ...
        rules: [
          {
            ...
            description: "Répondez aux questions sur Halloween et les créatures de la nuit.",
            emoji: "🎃"
          },
          {
            title: "Une seule chance",
            description: "Vous n'avez qu'une seule tentative par question. Choisissez bien !",
            emoji: "⚡"
          },
          {
            title: "Points et score",
            description: "Chaque bonne réponse vous rapporte 1 point. Attention aux pièges !",
            emoji: "💀"
          },
          {
            title: "Thème Halloween",
            description: "Testez vos connaissances sur les films d'horreur, les traditions et les légendes d'Halloween.",
            emoji: "🕷️"
          }
        ]
      },
        ...
        rules: [
          {
            ...
            description: "Answer questions about Halloween and creatures of the night.",
            emoji: "🎃"
          },
          {
            title: "One chance only",
            description: "You only have one attempt per question. Choose wisely!",
            emoji: "⚡"
          },
          {
            title: "Points and score",
            description: "Each correct answer earns you 1 point. Watch out for traps!",
            emoji: "💀"
          },
          {
            title: "Halloween theme",
            description: "Test your knowledge of horror movies, traditions and Halloween legends.",
            emoji: "🕷️"
          }
        ]
      },
        ...
        rules: [
          {
            ...
            description: "Responde preguntas sobre Halloween y criaturas de la noche.",
            emoji: "🎃"
          },
          {
            title: "Solo una oportunidad",
            description: "Solo tienes un intento por pregunta. ¡Elige sabiamente!",
            emoji: "⚡"
          },
          {
            title: "Puntos y puntuación",
            description: "Cada respuesta correcta te da 1 punto. ¡Cuidado con las trampas!",
            emoji: "💀"
          },
          {
            title: "Tema de Halloween",
            description: "Pon a prueba tus conocimientos sobre películas de terror, tradiciones y leyendas de Halloween.",
            emoji: "🕷️"
          }
        ]
      },
